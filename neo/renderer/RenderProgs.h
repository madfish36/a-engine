...
enum renderParm_t {
	...
	//MF
	RENDERPARM_ABCS_MODIFIERS,		// [0] Ambient / [1] Brightness / [2] Contrast / [3] Saturation
	RENDERPARM_AGLGT_MODIFIERS,		// [0] Ambient light blur / Ambient reflections level /[2] Glow strength / [3] Glow threshold
	RENDERPARM_GLOW_MODIFIERS,		// [0] MIX / [1] Lobe_1 / [2]  Lobe_2
	//MF END
