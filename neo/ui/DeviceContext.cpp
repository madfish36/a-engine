...
void idDeviceContext::Init() {
	...
	xOffset = 0.0f;
	yOffset = 0.0f;
	whiteImage = declManager->FindMaterial("textures/common/white.tga");
	...
	cursorImages[CURSOR_ARROW] = declManager->FindMaterial("ui/assets/cursors/guicursor_arrow.tga");
	cursorImages[CURSOR_HAND] = declManager->FindMaterial("ui/assets/cursors/guicursor_hand.tga");
	cursorImages[CURSOR_HAND_JOY1] = declManager->FindMaterial("ui/assets/cursors/guicursor_hand_cross.tga");
	cursorImages[CURSOR_HAND_JOY2] = declManager->FindMaterial("ui/assets/cursors/guicursor_hand_circle.tga");
	cursorImages[CURSOR_HAND_JOY3] = declManager->FindMaterial("ui/assets/cursors/guicursor_hand_square.tga");
	cursorImages[CURSOR_HAND_JOY4] = declManager->FindMaterial("ui/assets/cursors/guicursor_hand_triangle.tga");
	cursorImages[CURSOR_HAND_JOY1] = declManager->FindMaterial("ui/assets/cursors/guicursor_hand_a.tga");
	cursorImages[CURSOR_HAND_JOY2] = declManager->FindMaterial("ui/assets/cursors/guicursor_hand_b.tga");
	cursorImages[CURSOR_HAND_JOY3] = declManager->FindMaterial("ui/assets/cursors/guicursor_hand_x.tga");
	cursorImages[CURSOR_HAND_JOY4] = declManager->FindMaterial("ui/assets/cursors/guicursor_hand_y.tga");
	scrollBarImages[SCROLLBAR_HBACK] = declManager->FindMaterial("ui/assets/scrollbar/scrollbarh.tga");
	scrollBarImages[SCROLLBAR_VBACK] = declManager->FindMaterial("ui/assets/scrollbar/scrollbarv.tga");
	scrollBarImages[SCROLLBAR_THUMB] = declManager->FindMaterial("ui/assets/scrollbar/scrollbar_thumb.tga");
	scrollBarImages[SCROLLBAR_RIGHT] = declManager->FindMaterial("ui/assets/scrollbar/scrollbar_right.tga");
	scrollBarImages[SCROLLBAR_LEFT] = declManager->FindMaterial("ui/assets/scrollbar/scrollbar_left.tga");
	scrollBarImages[SCROLLBAR_UP] = declManager->FindMaterial("ui/assets/scrollbar/scrollbar_up.tga");
	scrollBarImages[SCROLLBAR_DOWN] = declManager->FindMaterial("ui/assets/scrollbar/scrollbar_down.tga");
