...
enum renderParm_t {
	...
	//MF START
	RENDERPARM_REFLECTIONLOBE_1,
	RENDERPARM_REFLECTIONLOBE_2,
	RENDERPARM_REFLECTIONLOBE_MIX,
	RENDERPARM_REFLECTIONMODIFIER,
	RENDERPARM_ACESEXPOSITION,
	RENDERPARM_AMBIENTLIGHT_MIX,
	//MF END
	RENDERPARM_TOTAL,
	RENDERPARM_USER = 128,
};
